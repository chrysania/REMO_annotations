...
for (i in all_chromosome) {
    message(i)
    annot <- readr::read_tsv(paste0("remo_annotation_brain_", i, ".tsv"), col_names = c('Module', 'Terms'))
...
write.table(x = remo, file = "../../data/brain/REMOv1_GRCh38_metadata.tsv", quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t")
...
# write as mtx file
writeMM(membership, "../../data/brain/REMOv1_GRCh38_bioterms/counts.mtx")
writeLines(rownames(membership), "../../data/brain/REMOv1_GRCh38_bioterms/rownames.txt")
writeLines(colnames(membership), "../../data/brain/REMOv1_GRCh38_bioterms/colnames.txt")

# write as h5 file
h5file <- H5File$new("../../data/brain/REMOv1_GRCh38_bioterms.h5", mode = "w")
...
# write as rds file
saveRDS(membership, "../../data/brain/REMOv1_GRCh38_bioterms.rds")